...
const numbers = '10' + 10;
console.log(typeof(numbers));   // Когда мы слаживаем что-то со строкой, в данном случае строка плюс число, нам выведется строка и результат будет не 20 как мы ожидаем, а ='1010'. Потому что число читается как строка и слаживает по итогу он строки, а не числа.
